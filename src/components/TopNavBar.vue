<template>
  <!-- Top Nav Bar -->
    <nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow" id="top-nav" >
      ...
      <ul class="navbar-nav ">
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          >
            ...
            <!-- <img  class="img-profile rounded-circle" src="../assets/images/avatar/undraw_profile.svg" />
            <span class="mr-2 d-none d-lg-inline text-gray-600 small" >Douglas McGee <i class="fa fa-caret-down"></i></span> -->
