        ...
        <div class="animated fadeIn">
            <div class="col-lg-12 d-flex breadcrumb-wrap">
                ...
                <div class="" v-if="patient">
                    <h4>Edit Patient</h4>
                    <div class="breadcrumb"><span>Patients</span>/ Edit Patient / {{ patient.body.first_name }}  {{ patient.body.last_name}}<span> </span></div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form-wizard>
                        <div class="alert-success my-5 text-center alert" v-if="message">
                            {{ message }}
                        </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      /**
       * @description Prepare data and call api to update patient information
       *
       */
      updatePatient() {
        ...
        this.$validator.validateAll().then(isValid => {
          ...
          let patient = {
            ...
            body: {
              ...
              registration_date: this.patient.body.registration_date,
              phone: this.phone,
              gender: this.gender,
          ...
          this.$http.put("/patients/" + this.patientId, patient ).then(response => {
              loader.hide();
      ...
      /**
       * @description Assign patients information to v-model.
       *
       */
      assignData() {
        let body = this.patient.body
        ...
        let date = new Date(body.birth_date)
