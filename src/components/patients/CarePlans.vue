    ...
    <div class="content patient-care-plan">
        <div class="animated fadeIn">
            <div class="col-lg-12 d-flex breadcrumb-wrap">
                ...
                <div class="">
                    <h4>Care Plan</h4>
                    <div class="breadcrumb" v-if="patient"><span>Patients / {{ patient.body.first_name + " " + patient.body.last_name }}</span> / Care Plan</div>
                </div>
            </div>
            <div class="col-md-12 d-flex justify-content-between mt-3">
                <div class="search-patient flex-grow-1 mr-3">
                    <div class="input-group md-form form-sm form-1 pl-0">
                        ...
                        <input class="form-control my-0 py-1 border-left-0" type="text" placeholder="Careplan title" aria-label="Search">
                    </div>
                </div>
            </div>
