                        ...
                        <div class="search">
                            <div class="input-group md-form form-sm form-1 pl-0">
                                ...
                                <input class="form-control my-0 py-1 border-left-0" type="text"
                                       placeholder="User name" aria-label="Search">
                            </div>
                        </div>
                    ...
                    <div class="patient-content float-right">
                        ...
                        <div class="right-side">
                            ...
                            <div class="register-patient">
                                <button class="btn" v-b-modal.modal-user><i class="fas fa-plus"></i>Create User</button>
                            </div>
                            ...
                            <b-modal id="modal-user" class="modal-header">
                                ...
                                <div class="form-group">
                                    <label for="patientHeight">Name</label>
                                    <input type="text" id="patientHeight" class="form-control form-coordinate height-input">
                                </div>
                                    
                                    

                                <div class="form-group">
                                    <label for="patientHeight">Email</label>
                                    <input type="text" id="patientHeight" class="form-control form-coordinate height-input">
                                </div>
                                <div class="form-group">
                                    <label for="patientHeight">Password</label>
                                    <input type="text" id="patientHeight" class="form-control form-coordinate height-input">
                                </div>
                                ...
                                <template v-slot:modal-footer>
                                    <div class="w-100">
                                        ...
                                        <b-button @click="creatole()" variant="link" :disabled="!newUser" size="md" class="float-right font-weight-bold p-0 pl-4 pr-1">
                                            Save
                                        </b-button>
                            ...
                            <b-modal id="modal-assign-role" class="modal-header">
                                ...
                                <template v-slot:modal-footer>
                                    <div class="w-100">
                                        ...
                                        <b-button variant="link" size="md" class="float-right font-weight-bold p-0" @click="$bvModal.hide('modal-assign-role')">
                                            Cancel
                                        </b-button>
                                    </div>
                                </template>
