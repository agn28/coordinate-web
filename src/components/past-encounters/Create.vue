...
<script>
  ...
  export default {
    ...
    created() {
      ...
      console.log("pressure", this.blood_pressure)
      console.log("test", this.blood_tests)
      console.log('mes', this.bodyMeasurements)
      console.log('ques', this.questionnaire)
      this.getPatient()
    }
  };
</script>
