    ...
    <div class="animated fadeIn">
      <div class="col-lg-12 d-flex breadcrumb-wrap">
        ...
        <div v-if="patient">
          ...
          <div class="breadcrumb"><span>Patients</span>/ <span>{{ patient.body.first_name + " " + patient.body.last_name }}</span> / <span>Create a New Encounter</span> / <span>Questionnaire</span> / Alcohol</div>
        </div>
      </div>
                  ...
                  <tab-content>
                    <div class="step-1">
                      <div class="question-msg">
                        <p><span><i class="fas fa-exclamation-circle"></i></span>Now I am going to ask you some questions about alcohol use.</p>
                      </div>
                      <div class="question-section">
                        <p>Did you drink any alcohol in the last 30 days?</p>

                        <div class="row mb-5">
                          <div class="col-lg-6">
                            <button @click="alcoholData.last_30_days = 'yes'" class="btn btn-light border w-100">Yes</button>
                          </div>
                          <div class="col-lg-6">
                            <button @click="alcoholData.last_30_days = 'no'" class="btn btn-light border w-100">No</button>
                          </div>
